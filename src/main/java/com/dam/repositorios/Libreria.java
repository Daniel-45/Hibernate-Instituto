...
public class Libreria {
	...
	// Pide un numero que tiene que estar entre un inicio y un fin. Hay que
	// introducir el mensaje a mostrar
	...
	// Da un numero aleatorio desde 1, introduciendo el maximo primero. Luego desde
	// un limite que se introduce devuelve solo 0.5
	...
	// Devuelve el numero de veces que esta repetida una plabra en un array String
	...
	// Devuelve el numero de veces que esta repetido un numero (int)
	...
	// Lee entre un rango de numeros y muestra n aviso.
	...
	// Devulve la posicion del mayor valor del array
