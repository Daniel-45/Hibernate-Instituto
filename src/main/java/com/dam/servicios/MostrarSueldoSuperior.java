...
public class MostrarSueldoSuperior implements Service {
	...
	public void execute() {
		...
		System.out.println("\n---------- EMPLEADOS CON SUELDO SUPERIOR O IGUAL A 1000 EUROS ------------");
		...
		System.out.println("\n------- FINAL EMPLEADOS CON SUELDO SUPERIOR O IGUAL A 1000 EUROS ---------");
